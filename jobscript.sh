...
cmd="srun --cores $SLURM_CPUS_ON_NODE snakemake \
    -s /zfs/omics/projects/amplicomics/bin/NanoITS_0.1/workflow/Snakefile \
    --configfile config.yaml --use-conda \
    --conda-prefix /zfs/omics/projects/amplicomics/bin/NanoITS_0.1/workflow/.snakemake/conda \
